...
bool cViewer::OnInit()
{
	...
	//m_text.Create(m_renderer, 36, true, "Arial", cColor::RED);
	m_text.Create(m_renderer, 36, true, "Arial", cColor::RED, L"Test");
...
void cViewer::OnRender(const float deltaSeconds)
{
	...
	if (m_renderer.ClearScene())
	{
		...
		m_text.Render(m_renderer, 100, 100);
		m_text.Render(m_renderer, 100, 150);
		m_text.Render(m_renderer, 100, 200);
		m_text.Render(m_renderer, 100, 250);

...
class CTerrain
{
	public:
		...
		void LoadTextures();
		void Render(graphic::cRenderer &renderer, graphic::cCamera *);
		void CreateTerrain();

		float DynamicTesselationFactor;
		float StaticTesselationFactor;
		void SetupNormalView(graphic::cCamera *);
		void SetupReflectionView(graphic::cCamera *);
		void SetupRefractionView(graphic::cCamera *);
		void SetupLightView(graphic::cCamera * );

...
void CTerrain::SetupLightView(graphic::cCamera *cam)
{
	...
	//Matrix44 mView = *D3DXMatrixLookAtLH(&mView,&EyePoint,&LookAtPoint,&lookUp);
	Matrix44 mView;
	mView.SetView2(EyePoint, LookAtPoint, lookUp);
	//Matrix44 mProjMatrix = *D3DXMatrixOrthoLH(&mProjMatrix,terrain_far_range*1.5,terrain_far_range,nr,fr);
